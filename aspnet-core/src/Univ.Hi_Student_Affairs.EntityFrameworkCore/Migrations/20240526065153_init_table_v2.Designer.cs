...
namespace Univ.Hi_Student_Affairs.Migrations
{
    ...
    [Migration("20240526065153_init_table_v2")]
    partial class init_table_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.AdmissionKind", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.FeeCalcType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.TypeLic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.TypeLicBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.Admission", b =>
                {
                    b.HasOne("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.AdmissionKind", null)
                        .WithMany("Admissions")
                        .HasForeignKey("AdmissionKindId");

                    b.HasOne("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.FeeCalcType", null)
                        .WithMany("Admissions")
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.TypeLicBranch", b =>
                {
                    b.HasOne("Univ.Hi_Student_Affairs.Domain.Initialization_Tables.Admission.TypeLic", null)
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Collage", b =>
                {
                    b.HasOne("Univ.Hi_Student_Affairs.CollType", null)
                        .WithMany("Collages")
                        .HasForeignKey("CollTypeId");

                    b.HasOne("Univ.Hi_Student_Affairs.UnivSection", null)
                        .WithMany("Collages")
            ...
            modelBuilder.Entity("Univ.Hi_Student_Affairs.Univ", b =>
                {
                    b.HasOne("Univ.Hi_Student_Affairs.UnivType", null)
                        .WithMany("Univs")
