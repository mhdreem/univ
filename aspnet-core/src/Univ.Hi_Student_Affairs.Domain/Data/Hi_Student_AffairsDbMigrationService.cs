...
public class Hi_Student_AffairsDbMigrationService : ITransientDependency
{
    ...
    public Hi_Student_AffairsDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IHi_Student_AffairsDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<Hi_Student_AffairsDbMigrationService>.Instance;
    }
